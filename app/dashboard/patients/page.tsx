    ...
    <div className="min-h-screen bg-gray-950 flex">
      ...
      <div className="w-64 bg-gray-900 border-r border-gray-800 flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          ...
          <a href="/dashboard/patients" className="flex items-center gap-3 px-3 py-2 rounded-lg bg-gray-800 text-white text-sm font-medium">
            <span>👥</span> Patients
          </a>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex-1 p-8 overflow-auto">
          ...
          <div className="flex items-center gap-4 mb-6">
            <input type="text" placeholder="Search patients..." className="bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-500 text-sm focus:outline-none focus:border-cyan-400 transition w-64" />
            ...
            <table className="w-full">
              ...
              <tbody className="text-sm divide-y divide-gray-800">
                {[
                  ...
                  <tr key={patient.name} className="hover:bg-gray-800 transition">
                    ...
                    <td className="px-6 py-4">
                      <button className="text-cyan-400 hover:text-cyan-300 text-xs transition">View →</button>
                    </td>
                  </tr>
                ))}
              </tbody>
