      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="h-16 bg-gray-900 border-b border-gray-800 flex items-center justify-between px-8">
          <div>
            ...
            <p className="text-gray-500 text-xs">Welcome back, Sandra</p>
          </div>
        ...
        <div className="flex-1 p-8 overflow-auto">
          ...
          <div className="grid grid-cols-4 gap-6 mb-8">
            {[
              ...
              { label: "Avg Processing Time", value: "2.4 days", change: "-0.3d", up: true },
            ].map((kpi) => (
              ...
              <table className="w-full">
                ...
                <tbody className="text-sm">
                  {[
                    ...
                    { id: "CLM-8820", patient: "Maria Santos", provider: "Peak Surgical", amount: "$12,500", status: "Pending", color: "yellow" },
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { label: "Rejected", value: 5, color: "bg-red-400" },
                ].map((item) => (
                  <div key={item.label}>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
            ...
            <div className="grid grid-cols-4 gap-4">
              {[
                { name: "Epic EHR", status: "Connected", up: true },
                { name: "Waystar Clearinghouse", status: "Connected", up: true },
                { name: "Change Healthcare", status: "Degraded", up: false },
                { name: "Availity Portal", status: "Connected", up: true },
              ].map((sys) => (
                <div key={sys.name} className="bg-gray-800 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className={`w-2 h-2 rounded-full ${sys.up ? 'bg-green-400' : 'bg-yellow-400'}`}></div>
                    <span className={`text-xs font-medium ${sys.up ? 'text-green-400' : 'text-yellow-400'}`}>
                      {sys.status}
                    </span>
                  </div>
